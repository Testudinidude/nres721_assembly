...
### steps 1 & 2
We'll do this first assembly step-by-step and talk about the output. First, we'll run step 1. **Note: the `-c 2` argument tells my computer to run this using two cores. You can adjust this as necsesary depending upon what resources you have available.**

```{bash eval = FALSE}
ipyrad -p params-ubrucei_denovo.txt -s 1 -c
```
