...
* `[7] [datatype]` : change this parameter to `pairddrad` ; although these are RADcap data and thus, `pair3rad` might seem most appropriate, we have already independently demultiplexed and "decloned" the reads and will treat them as `pairddrad` data for the purposes of this tutorial
