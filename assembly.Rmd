...
### steps 4 & 5
Next, we'll run steps 4 and 5 together. These steps estimate sequencing error rates, heterozygosity, and call consensus sequences for each individual.
...
### step 6
We'll skip over the results from this step and proceed immediately to step 6. This is another "clustering" step, but instead of clustering reads within individuals, we're clustering loci among individuals. With many samples, this step can be computationally intensive, but it should run quite quickly for us.
...
<div class="alert alert-info">
  <strong>Discussion:</strong> How is this formatted? Where did R1 and R2 data end up?
</div>

Create a new parameters file here. 
